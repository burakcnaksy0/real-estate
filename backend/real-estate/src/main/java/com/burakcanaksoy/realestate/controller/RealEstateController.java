...
public class RealEstateController {
    ...
    @GetMapping("/search")
    public ResponseEntity<Page<RealEstateResponse>> search(@ModelAttribute RealEstateFilterRequest filter, Pageable pageable) {
        return new ResponseEntity<>(this.realEstateService.search(filter, pageable), HttpStatus.OK);
    }

    @PostMapping()
    public ResponseEntity<RealEstateResponse> createRealEstate(@RequestBody @Valid RealEstateCreateRequest realEstateCreateRequest){
        return new ResponseEntity<>(this.realEstateService.createRealEstate(realEstateCreateRequest),HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<RealEstateResponse> updateRealEstate(@PathVariable Long realEstateId , @Valid @RequestBody RealEstateUpdateRequest request){
