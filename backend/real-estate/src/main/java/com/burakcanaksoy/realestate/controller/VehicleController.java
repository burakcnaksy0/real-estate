...
public class VehicleController {
    ...
    @GetMapping("/search")
    public ResponseEntity<Page<VehicleResponse>> search(@ModelAttribute VehicleFilterRequest filter, Pageable pageable) {
        return new ResponseEntity<>(this.vehicleService.search(filter, pageable), HttpStatus.OK);
    }

    @PostMapping()
    public ResponseEntity<VehicleResponse> createVehicle(@RequestBody @Valid VehicleCreateRequest vehicleCreateRequest){
    ...
    public ResponseEntity<VehicleResponse> updateVehicle(@PathVariable Long vehicleId , @Valid @RequestBody VehicleUpdateRequest request){
